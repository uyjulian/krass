...
$(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlidec.a $(DEPENDENCY_OUTPUT_DIRECTORY)/lib/libbrotlicommon.a: | $(DEPENDENCY_SOURCE_DIRECTORY_BROTLI)/aclocal.m4 $(DEPENDENCY_OUTPUT_DIRECTORY)
